...
class UnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc = 3, output_nc = 3, num_downs = 6, ngf=64, norm_layer=nn.BatchNorm2d, dropout_rate=False):
        ...
        for i in range(num_downs - 5):          # add intermediate layers with ngf * 8 filters
            unet_block = UnetSkipConnectionBlock(ngf * 8, ngf * 8, input_nc=None, submodule=unet_block, norm_layer=norm_layer, use_dropout=dropout_rate)
